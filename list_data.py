...
for name in customer_names:
    ...
    print(name + " - VLAN: " + str(customer_vlan) + " - IP Address: " + customer_ip + " IP Correto: " + is_ip_address.is_ip_address(customer_ip) + " IP na Rede Correta: " + is_ip_address.is_ip_correct_network(customer_ip))
